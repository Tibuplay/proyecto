...
void combate_maquina(nodoalien *&listaaliens,nodoitem *&listaitems,nodobioma *&listabiomas){
    ...
    for(int i=0; i<5; i++){
    	...
    	while (encontrado==false){
        	...
        	if(items->indice!=buscador){
        		cout<<endl<<"Objeto no encontrado, vuelva a intentar: ";
        	    items=listaitems;
				}
			else{
           		encontrado=true;
	...
	cout<<"Tras la randomizacion de especies, los equipos quedaron: "<<endl;
	for(int i=0;i<3;i++){
	...
	cout<<"Ahora que hemos seleccionado a los personajes, empecemos el combate"<<endl<<endl;
		...
		while(seleccionado==false){
			...
			if((buscador==1||buscador==2||buscador==3)){
				...
				if(soldados1[combatiente1].alien.hp>0){
					...
					cout<<endl<<"El soldado seleccionado esta fuera de combate, seleccione otro";
				}
			}else{
				cout<<endl<<"Soldado no encontrado, seleccione uno de los 3: ";
			}
				...
				if(buscador==1||buscador==2||buscador==3||buscador==4||buscador==5){
					...
					if(obj!=obj1&&obj!=obj2&&obj!=obj3){
						if(obj1==-1){
							...
							obj3=obj;
							cout<<"Los 3 objetos que portara el soldado fueron seleccionados. El combate empezara"<<endl;
							seleccionado=true;
						}
						}
						}else{
					...
					cout<<endl<<"Objeto no encontrado, seleccione uno de los 5: ";
					i--;
				}
	}seleccionado==false;
	}
	...
	cout<<"Cual de los 2 aliens ataca primero se decidira aleatoriamente, suerte!!"<<endl;
	int moneda=0;
			...
			if(safe1==safe2){
				...
				if(moneda==0){
					...
					switch(soldados1[combatiente1].item1.tipo){
						case 1:
							cout<<soldados1[combatiente1].alien.nombre<<" ha atacado usando "<<soldados1[combatiente1].item1.nombre<<endl;
							cout<<"Ha causado: "<<soldados1[combatiente1].item1.valor<<" de dano usando "<<soldados1[combatiente1].item1.nombre<<endl;
							if((soldados2[combatiente2].item1.tipo==2&&item21)||(soldados2[combatiente2].item2.tipo==2&&item22)||(soldados2[combatiente2].item3.tipo==2&&item23)){
								if(soldados2[combatiente2].item1.tipo==2&&item21){
									defensa+=soldados2[combatiente2].item1.valor;
									escudo+=soldados2[combatiente2].item1.defensa;
									escudo+=soldados2[combatiente2].item1.defensa=0;
									soldados2[combatiente2].alien.nrg-=escudo+=soldados2[combatiente2].item1.nrgconum;
								}
								if(soldados2[combatiente2].item2.tipo==2&&item22){
									defensa+=soldados2[combatiente2].item2.valor;
									escudo+=soldados2[combatiente2].item2.defensa;
									escudo+=soldados2[combatiente2].item2.defensa=0;
									soldados2[combatiente2].alien.nrg-=escudo+=soldados2[combatiente2].item2.nrgconum;
									}
								if(soldados2[combatiente2].item3.tipo==2&&item23){
									defensa+=soldados2[combatiente2].item3.valor;
									escudo+=soldados2[combatiente2].item3.defensa;
									escudo+=soldados2[combatiente2].item3.defensa=0;
									soldados2[combatiente2].alien.nrg-=escudo+=soldados2[combatiente2].item3.nrgconum;
									}}
								dano=soldados1[combatiente1].item1.valor;
								dano=dano-(dano*defensa/100);
								recibido=escudo-dano;
								if(recibido<0){
									cout<<soldados1[combatiente1].item1.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados2[combatiente2].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" ha recibido "<<(recibido*(-1))<<" de dano"<<endl;
									cout<<soldados1[combatiente1].alien.nombre<<" ha perdido "<<soldados1[combatiente1].item1.nrgconum<<" ptos de energia"<<endl;
									soldados1[combatiente1].alien.nrg-=soldados1[combatiente1].item1.nrgconum;
									soldados2[combatiente2].alien.hp+=recibido;
								}else{
									cout<<soldados1[combatiente1].item1.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados2[combatiente2].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" no ha recibido dano";
									cout<<soldados1[combatiente1].alien.nombre<<" ha perdido "<<soldados1[combatiente1].item1.nrgconum<<" ptos de energia"<<endl;
									soldados1[combatiente1].alien.nrg-=soldados1[combatiente1].item1.nrgconum;
								}
								escudo=escudo-dano;
								...
								if(soldados2[combatiente2].item1.tipo==2&&item21){
									escudo+=soldados2[combatiente2].item1.defensa=escudo/n;
								}
								if(soldados2[combatiente2].item2.tipo==2&&item22){
									escudo+=soldados2[combatiente2].item2.defensa/n;
									}
								if(soldados2[combatiente2].item3.tipo==2&&item23){
									escudo+=soldados2[combatiente2].item3.defensa/n;
									}
						break;
						case 3:
							cout<<soldados1[combatiente1].alien.nombre<<" ha recuperado "<<soldados1[combatiente1].item1.apoyo<<" usando "<<soldados1[combatiente1].item1.nombre<<endl;
							cout<<"Ha recuperado: "<<soldados1[combatiente1].item1.valor<<" puntos de "<<soldados1[combatiente1].item1.apoyo<<endl;
							cout<<soldados1[combatiente1].item1.nombre<<" ha perdido "<<soldados1[combatiente1].item1.nrgconum<<" ptos de energia"<<endl;
							soldados1[combatiente1].alien.nrg-=soldados1[combatiente1].item1.nrgconum;
							break;
					...
					switch(soldados1[combatiente1].item2.tipo){
						case 1:
							cout<<soldados1[combatiente1].alien.nombre<<" ha atacado usando "<<soldados1[combatiente1].item2.nombre<<endl;
							cout<<"Ha causado: "<<soldados1[combatiente1].item2.valor<<" de dano usando "<<soldados1[combatiente1].item2.nombre<<endl;
							if((soldados2[combatiente2].item1.tipo==2&&item21)||(soldados2[combatiente2].item2.tipo==2&&item22)||(soldados2[combatiente2].item3.tipo==2&&item23)){
								if(soldados2[combatiente2].item1.tipo==2&&item21){
									defensa+=soldados2[combatiente2].item1.valor;
									escudo+=soldados2[combatiente2].item1.defensa;
								...
								dano=soldados1[combatiente1].item2.valor;
								dano=dano-(dano*defensa/100);
								recibido=escudo-dano;
								if(recibido<0){
									cout<<soldados1[combatiente1].item2.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados2[combatiente2].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" ha recibido "<<(recibido*(-1))<<" de dano"<<endl;
									cout<<soldados1[combatiente1].alien.nombre<<" ha perdido "<<soldados1[combatiente1].item2.nrgconum<<" ptos de energia"<<endl;
									soldados1[combatiente1].alien.nrg-=soldados1[combatiente1].item2.nrgconum;
									soldados2[combatiente2].alien.hp+=recibido;
								}else{
									cout<<soldados1[combatiente1].item1.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados2[combatiente2].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" no ha recibido dano";
						...
						break;
						case 3:
							cout<<soldados1[combatiente1].alien.nombre<<" ha recuperado "<<soldados1[combatiente1].item2.apoyo<<" usando "<<soldados1[combatiente1].item2.nombre<<endl;
							cout<<"Ha recuperado: "<<soldados1[combatiente1].item2.valor<<" puntos de "<<soldados1[combatiente1].item2.apoyo<<endl;
							cout<<soldados1[combatiente1].alien.nombre<<" ha perdido "<<soldados1[combatiente1].item2.nrgconum<<" ptos de energia"<<endl;
							soldados1[combatiente1].alien.nrg-=soldados1[combatiente1].item2.nrgconum;
							break;
					...
					switch(soldados1[combatiente1].item3.tipo){
						case 1:
							cout<<soldados1[combatiente1].alien.nombre<<" ha atacado usando "<<soldados1[combatiente1].item3.nombre<<endl;
							cout<<"Ha causado: "<<soldados1[combatiente1].item3.valor<<" de dano usando "<<soldados1[combatiente1].item3.nombre<<endl;
							if((soldados2[combatiente2].item1.tipo==2&&item21)||(soldados2[combatiente2].item2.tipo==2&&item22)||(soldados2[combatiente2].item3.tipo==2&&item23)){
								if(soldados2[combatiente2].item1.tipo==2&&item21){
									defensa+=soldados2[combatiente2].item1.valor;
									escudo+=soldados2[combatiente2].item1.defensa;
								...
								dano=soldados1[combatiente1].item3.valor;
								dano=dano-(dano*defensa/100);
								recibido=escudo-dano;
								if(recibido<0){
									cout<<soldados1[combatiente1].item3.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados2[combatiente2].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" ha recibido "<<(recibido*(-1))<<" de dano"<<endl;
									cout<<soldados1[combatiente1].alien.nombre<<" ha perdido "<<soldados1[combatiente1].item3.nrgconum<<" ptos de energia"<<endl;
									soldados1[combatiente1].alien.nrg-=soldados1[combatiente1].item3.nrgconum;
									soldados2[combatiente2].alien.hp+=recibido;
								}else{
									cout<<soldados1[combatiente1].item3.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados2[combatiente2].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" no ha recibido dano";
						...
						break;
						case 3:
							cout<<soldados1[combatiente1].alien.nombre<<" ha recuperado "<<soldados1[combatiente1].item3.apoyo<<" usando "<<soldados1[combatiente1].item3.nombre<<endl;
							cout<<"Ha recuperado: "<<soldados1[combatiente1].item2.valor<<" puntos de "<<soldados1[combatiente1].item2.apoyo<<endl;
							cout<<soldados1[combatiente1].alien.nombre<<" ha perdido "<<soldados1[combatiente1].item3.nrgconum<<" ptos de energia"<<endl;
							soldados1[combatiente1].alien.nrg-=soldados1[combatiente1].item3.nrgconum;
							break;
					...
					if(item21){
					switch(soldados2[combatiente2].item1.tipo){
						case 1:
							cout<<soldados2[combatiente2].alien.nombre<<" ha atacado usando "<<soldados2[combatiente2].item1.nombre<<endl;
							cout<<"Ha causado: "<<soldados2[combatiente2].item1.valor<<" de dano usando "<<soldados2[combatiente2].item1.nombre<<endl;
							if((soldados1[combatiente1].item1.tipo==2&&item11)||(soldados1[combatiente1].item2.tipo==2&&item12)||(soldados1[combatiente1].item3.tipo==2&&item13)){
								if(soldados1[combatiente1].item1.tipo==2&&item11){
									defensa+=soldados1[combatiente1].item1.valor;
									escudo+=soldados1[combatiente1].item1.defensa;
									escudo+=soldados1[combatiente1].item1.defensa=0;
									soldados1[combatiente1].alien.nrg-=escudo+=soldados1[combatiente1].item1.nrgconum;
								}
								if(soldados1[combatiente1].item2.tipo==2&&item12){
									defensa+=soldados1[combatiente1].item2.valor;
									escudo+=soldados1[combatiente1].item2.defensa;
									escudo+=soldados1[combatiente1].item2.defensa=0;
									soldados1[combatiente1].alien.nrg-=escudo+=soldados1[combatiente1].item2.nrgconum;
									}
								if(soldados1[combatiente1].item3.tipo==2&&item13){
									defensa+=soldados1[combatiente1].item3.valor;
									escudo+=soldados1[combatiente1].item3.defensa;
									escudo+=soldados1[combatiente1].item3.defensa=0;
									soldados1[combatiente1].alien.nrg-=escudo+=soldados1[combatiente1].item3.nrgconum;
									}}
								dano=soldados2[combatiente2].item1.valor;
								dano=dano-(dano*defensa/100);
								recibido=escudo-dano;
								if(recibido<0){
									cout<<soldados2[combatiente2].item1.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados1[combatiente1].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados1[combatiente1].alien.nombre<<" ha recibido "<<(recibido*(-1))<<" de dano"<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" ha perdido "<<soldados2[combatiente2].item1.nrgconum<<" ptos de energia"<<endl;
									soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item1.nrgconum;
									soldados1[combatiente1].alien.hp+=recibido;
								}else{
									cout<<soldados2[combatiente1].item1.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados1[combatiente1].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados1[combatiente2].alien.nombre<<" no ha recibido dano";
									cout<<soldados2[combatiente2].alien.nombre<<" ha perdido "<<soldados2[combatiente2].item1.nrgconum<<" ptos de energia"<<endl;
									soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item1.nrgconum;
								}
								escudo=escudo-dano;
								if(soldados1[combatiente1].item1.tipo==2&&item21){
									n++;
								}
								if(soldados1[combatiente1].item2.tipo==2&&item22){
									n++;
									}
								if(soldados1[combatiente1].item3.tipo==2&&item23){
									n++;
									}
								if(soldados1[combatiente1].item1.tipo==2&&item21){
									escudo+=soldados1[combatiente1].item1.defensa=escudo/n;
								}
								if(soldados1[combatiente1].item1.tipo==2&&item22){
									escudo+=soldados1[combatiente1].item2.defensa/n;
									}
								if(soldados1[combatiente1].item3.tipo==2&&item23){
									escudo+=soldados1[combatiente1].item3.defensa/n;
									}
						break;
						case 3:
							cout<<soldados2[combatiente2].alien.nombre<<" ha recuperado "<<soldados2[combatiente2].item1.apoyo<<" usando "<<soldados2[combatiente2].item1.nombre<<endl;
							cout<<"Ha recuperado: "<<soldados2[combatiente2].item1.valor<<" puntos de "<<soldados2[combatiente2].item1.apoyo<<endl;
							cout<<soldados2[combatiente2].item1.nombre<<" ha perdido "<<soldados2[combatiente2].item1.nrgconum<<" ptos de energia"<<endl;
							soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item1.nrgconum;
							break;
					}
					}
					if(item22){
					switch(soldados2[combatiente2].item2.tipo){
						case 1:
							cout<<soldados2[combatiente2].alien.nombre<<" ha atacado usando "<<soldados2[combatiente2].item2.nombre<<endl;
							cout<<"Ha causado: "<<soldados2[combatiente2].item2.valor<<" de dano usando "<<soldados2[combatiente2].item2.nombre<<endl;
							if((soldados1[combatiente1].item1.tipo==2&&item11)||(soldados1[combatiente1].item2.tipo==2&&item12)||(soldados1[combatiente1].item3.tipo==2&&item13)){
								if(soldados1[combatiente1].item1.tipo==2&&item11){
									defensa+=soldados1[combatiente1].item1.valor;
									escudo+=soldados1[combatiente1].item1.defensa;
								...
								dano=soldados2[combatiente2].item2.valor;
								dano=dano-(dano*defensa/100);
								recibido=escudo-dano;
								if(recibido<0){
									cout<<soldados2[combatiente2].item2.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados1[combatiente1].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados1[combatiente1].alien.nombre<<" ha recibido "<<(recibido*(-1))<<" de dano"<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" ha perdido "<<soldados2[combatiente2].item2.nrgconum<<" ptos de energia"<<endl;
									soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item2.nrgconum;
									soldados1[combatiente1].alien.hp+=recibido;
								}else{
									cout<<soldados2[combatiente1].item2.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados1[combatiente1].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados1[combatiente2].alien.nombre<<" no ha recibido dano";
									cout<<soldados2[combatiente2].alien.nombre<<" ha perdido "<<soldados2[combatiente2].item2.nrgconum<<" ptos de energia"<<endl;
									soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item2.nrgconum;
								}
						...
						break;
						case 3:
							cout<<soldados2[combatiente2].alien.nombre<<" ha recuperado "<<soldados2[combatiente2].item2.apoyo<<" usando "<<soldados2[combatiente2].item2.nombre<<endl;
							cout<<"Ha recuperado: "<<soldados2[combatiente2].item2.valor<<" puntos de "<<soldados2[combatiente2].item2.apoyo<<endl;
							cout<<soldados2[combatiente2].item2.nombre<<" ha perdido "<<soldados2[combatiente2].item2.nrgconum<<" ptos de energia"<<endl;
							soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item2.nrgconum;
							break;
					}
					}
					if(item23){
					switch(soldados2[combatiente2].item3.tipo){
						case 1:
							cout<<soldados2[combatiente2].alien.nombre<<" ha atacado usando "<<soldados2[combatiente2].item3.nombre<<endl;
							cout<<"Ha causado: "<<soldados2[combatiente2].item3.valor<<" de dano usando "<<soldados2[combatiente2].item3.nombre<<endl;
							if((soldados1[combatiente1].item1.tipo==2&&item11)||(soldados1[combatiente1].item2.tipo==2&&item12)||(soldados1[combatiente1].item3.tipo==2&&item13)){
								if(soldados1[combatiente1].item1.tipo==2&&item11){
									defensa+=soldados1[combatiente1].item1.valor;
									escudo+=soldados1[combatiente1].item1.defensa;
								...
								dano=soldados2[combatiente2].item3.valor;
								dano=dano-(dano*defensa/100);
								recibido=escudo-dano;
								if(recibido<0){
									cout<<soldados2[combatiente2].item3.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados1[combatiente1].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados1[combatiente1].alien.nombre<<" ha recibido "<<(recibido*(-1))<<" de dano"<<endl;
									cout<<soldados2[combatiente2].alien.nombre<<" ha perdido "<<soldados2[combatiente2].item3.nrgconum<<" ptos de energia"<<endl;
									soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item3.nrgconum;
									soldados1[combatiente1].alien.hp+=recibido;
								}else{
									cout<<soldados2[combatiente1].item3.nombre<< "ha inflingido "<<dano<< "de dano debido a la proteccion del enemigo, pero "<<soldados1[combatiente1].alien.nombre<<" tenia "<<escudo<<" puntos de escudo."<<endl;
									cout<<soldados1[combatiente2].alien.nombre<<" no ha recibido dano";
									cout<<soldados2[combatiente2].alien.nombre<<" ha perdido "<<soldados2[combatiente2].item3.nrgconum<<" ptos de energia"<<endl;
									soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item3.nrgconum;
								}
						...
						break;
						case 3:
							cout<<soldados2[combatiente2].alien.nombre<<" ha recuperado "<<soldados2[combatiente2].item3.apoyo<<" usando "<<soldados2[combatiente2].item3.nombre<<endl;
							cout<<"Ha recuperado: "<<soldados2[combatiente2].item3.valor<<" puntos de "<<soldados2[combatiente2].item3.apoyo<<endl;
							cout<<soldados2[combatiente2].item3.nombre<<" ha perdido "<<soldados2[combatiente2].item3.nrgconum<<" ptos de energia"<<endl;
							soldados2[combatiente2].alien.nrg-=soldados2[combatiente2].item3.nrgconum;
							break;
						}
					}
			}else{//otra caras de la moneda
				if(item21){
					switch(soldados2[combatiente2].item1.tipo){
						case 1:
							cout<<soldados2[combatiente2].alien.nombre<<" ha atacado usando "<<soldados2[combatiente2].item1.nombre<<endl;
	...
	cout<<"Felicidades jugador, usted gano, la galaxia fue salvada!!!";
}else{
	cout<<"Malas noticias jugador, perdio la batalla, pero no la guerra!!! Mejor suerte la proxima";
}
}//final del combate
    ...
    while (on){
        ...
        case 2:
			...
			while(on2==true){
        		...
        		cout<<"2. Iniciar un combate contra otro juegador."<<endl;
